...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ha(){return new _i({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Wa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ua(){return new _i({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Wa(),fragmentShader:`
	...
	`}var Ga=class extends zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Ur(s,c),u=new Yi(-1,1,1,-1,0,1),d=null,f=null,p=!1,m,h=null,g=[],_=!1;this.setSize=function(e,t){a.setSize(e,t),o.setSize(e,t);for(let n=0;n<g.length;n++){let r=g[n];r.setSize&&r.setSize(e,t)}},this.setEffects=function(e){g=e,_=g.length>0&&g[0].isRenderPass===!0;let t=a.width,n=a.height;for(let e=0;e<g.length;e++){let r=g[e];r.setSize&&r.setSize(t,n)}},this.begin=function(e,t){if(p||e.toneMapping===0&&g.length===0)return!1;if(h=t,t!==null){let e=t.width,n=t.height;(a.width!==e||a.height!==n)&&this.setSize(e,n)}return _===!1&&e.setRenderTarget(a),m=e.toneMapping,e.toneMapping=0,!0},this.hasRenderPass=function(){return _},this.end=function(e,t){e.toneMapping=m,p=!0;let n=a,r=o;for(let i=0;i<g.length;i++){let a=g[i];if(a.enabled!==!1&&(a.render(e,r,n,t),a.needsSwap!==!1)){let e=n;n=r,r=e}}if(d!==e.outputColorSpace||f!==e.toneMapping){d=e.outputColorSpace,f=e.toneMapping,c.defines={},Et.getTransfer(d)===`srgb`&&(c.defines.SRGB_TRANSFER=``);let t=$a[f];t&&(c.defines[t]=``),c.needsUpdate=!0}c.uniforms.tDiffuse.value=n.texture,e.setRenderTarget(h),e.render(l,u),h=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){a.depthTexture&&a.depthTexture.dispose(),a.dispose(),o.dispose(),s.dispose(),c.dispose()}}var to=new It,no=new ii(1,1),X=new Bt,ro=new Vt,io=new ni,ao=[],oo=[],so=new Float32Array(16),co=new Float32Array(9),lo=new Float32Array(4);function uo(e,t,n){let r=e[0];if(r<=0||r>0)return e;let i=t*n,a=ao[i];if(a===void 0&&(a=new Float32Array(i),ao[i]=a),t!==0){r.toArray(a,0);for(let r=1,i=0;r!==t;++r)i+=n,e[r].toArray(a,i)}return a}function fo(e,t){if(e.length!==t.length)return!1;for(let n=0,r=e.length;n<r;n++)if(e[n]!==t[n])return!1;return!0}function Z(e,t){for(let n=0,r=t.length;n<r;n++)e[n]=t[n]}function po(e,t){let n=oo[t];n===void 0&&(n=new Int32Array(t),oo[t]=n);for(let r=0;r!==t;++r)n[r]=e.allocateTextureUnit();return n}function mo(e,t){let n=this.cache;n[0]!==t&&(e.uniform1f(this.addr,t),n[0]=t)}function ho(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2f(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(fo(n,t))return;e.uniform2fv(this.addr,t),Z(n,t)}}function go(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3f(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else if(t.r!==void 0)(n[0]!==t.r||n[1]!==t.g||n[2]!==t.b)&&(e.uniform3f(this.addr,t.r,t.g,t.b),n[0]=t.r,n[1]=t.g,n[2]=t.b);else{if(fo(n,t))return;e.uniform3fv(this.addr,t),Z(n,t)}}function _o(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4f(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(fo(n,t))return;e.uniform4fv(this.addr,t),Z(n,t)}}function vo(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(fo(n,t))return;e.uniformMatrix2fv(this.addr,!1,t),Z(n,t)}else{if(fo(n,r))return;lo.set(r),e.uniformMatrix2fv(this.addr,!1,lo),Z(n,r)}}function yo(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(fo(n,t))return;e.uniformMatrix3fv(this.addr,!1,t),Z(n,t)}else{if(fo(n,r))return;co.set(r),e.uniformMatrix3fv(this.addr,!1,co),Z(n,r)}}function bo(e,t){let n=this.cache,r=t.elements;if(r===void 0){if(fo(n,t))return;e.uniformMatrix4fv(this.addr,!1,t),Z(n,t)}else{if(fo(n,r))return;so.set(r),e.uniformMatrix4fv(this.addr,!1,so),Z(n,r)}}function xo(e,t){let n=this.cache;n[0]!==t&&(e.uniform1i(this.addr,t),n[0]=t)}function So(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2i(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(fo(n,t))return;e.uniform2iv(this.addr,t),Z(n,t)}}function Co(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3i(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(fo(n,t))return;e.uniform3iv(this.addr,t),Z(n,t)}}function wo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4i(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(fo(n,t))return;e.uniform4iv(this.addr,t),Z(n,t)}}function To(e,t){let n=this.cache;n[0]!==t&&(e.uniform1ui(this.addr,t),n[0]=t)}function Eo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y)&&(e.uniform2ui(this.addr,t.x,t.y),n[0]=t.x,n[1]=t.y);else{if(fo(n,t))return;e.uniform2uiv(this.addr,t),Z(n,t)}}function Do(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z)&&(e.uniform3ui(this.addr,t.x,t.y,t.z),n[0]=t.x,n[1]=t.y,n[2]=t.z);else{if(fo(n,t))return;e.uniform3uiv(this.addr,t),Z(n,t)}}function Oo(e,t){let n=this.cache;if(t.x!==void 0)(n[0]!==t.x||n[1]!==t.y||n[2]!==t.z||n[3]!==t.w)&&(e.uniform4ui(this.addr,t.x,t.y,t.z,t.w),n[0]=t.x,n[1]=t.y,n[2]=t.z,n[3]=t.w);else{if(fo(n,t))return;e.uniform4uiv(this.addr,t),Z(n,t)}}function ko(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i);let a;this.type===e.SAMPLER_2D_SHADOW?(no.compareFunction=n.isReversedDepthBuffer()?518:515,a=no):a=to,n.setTexture2D(t||a,i)}function Ao(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture3D(t||ro,i)}function jo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTextureCube(t||io,i)}function Mo(e,t,n){let r=this.cache,i=n.allocateTextureUnit();r[0]!==i&&(e.uniform1i(this.addr,i),r[0]=i),n.setTexture2DArray(t||X,i)}function No(e){switch(e){case 5126:return mo;case 35664:return ho;case 35665:return go;case 35666:return _o;case 35674:return vo;case 35675:return yo;case 35676:return bo;case 5124:case 35670:return xo;case 35667:case 35671:return So;case 35668:case 35672:return Co;case 35669:case 35673:return wo;case 5125:return To;case 36294:return Eo;case 36295:return Do;case 36296:return Oo;case 35678:case 36198:case 36298:case 36306:case 35682:return ko;case 35679:case 36299:case 36307:return Ao;case 35680:case 36300:case 36308:case 36293:return jo;case 36289:case 36303:case 36311:case 36292:return Mo}}function Po(e,t){e.uniform1fv(this.addr,t)}function Fo(e,t){let n=uo(t,this.size,2);e.uniform2fv(this.addr,n)}function Io(e,t){let n=uo(t,this.size,3);e.uniform3fv(this.addr,n)}function Lo(e,t){let n=uo(t,this.size,4);e.uniform4fv(this.addr,n)}function Ro(e,t){let n=uo(t,this.size,4);e.uniformMatrix2fv(this.addr,!1,n)}function zo(e,t){let n=uo(t,this.size,9);e.uniformMatrix3fv(this.addr,!1,n)}function Bo(e,t){let n=uo(t,this.size,16);e.uniformMatrix4fv(this.addr,!1,n)}function Vo(e,t){e.uniform1iv(this.addr,t)}function Ho(e,t){e.uniform2iv(this.addr,t)}function Uo(e,t){e.uniform3iv(this.addr,t)}function Wo(e,t){e.uniform4iv(this.addr,t)}function Go(e,t){e.uniform1uiv(this.addr,t)}function Ko(e,t){e.uniform2uiv(this.addr,t)}function qo(e,t){e.uniform3uiv(this.addr,t)}function Jo(e,t){e.uniform4uiv(this.addr,t)}function Yo(e,t,n){let r=this.cache,i=t.length,a=po(n,i);fo(r,a)||(e.uniform1iv(this.addr,a),Z(r,a));let o;o=this.type===e.SAMPLER_2D_SHADOW?no:to;for(let e=0;e!==i;++e)n.setTexture2D(t[e]||o,a[e])}function Xo(e,t,n){let r=this.cache,i=t.length,a=po(n,i);fo(r,a)||(e.uniform1iv(this.addr,a),Z(r,a));for(let e=0;e!==i;++e)n.setTexture3D(t[e]||ro,a[e])}function Zo(e,t,n){let r=this.cache,i=t.length,a=po(n,i);fo(r,a)||(e.uniform1iv(this.addr,a),Z(r,a));for(let e=0;e!==i;++e)n.setTextureCube(t[e]||io,a[e])}function Qo(e,t,n){let r=this.cache,i=t.length,a=po(n,i);fo(r,a)||(e.uniform1iv(this.addr,a),Z(r,a));for(let e=0;e!==i;++e)n.setTexture2DArray(t[e]||X,a[e])}function $o(e){switch(e){case 5126:return Po;case 35664:return Fo;case 35665:return Io;case 35666:return Lo;case 35674:return Ro;case 35675:return zo;case 35676:return Bo;case 5124:case 35670:return Vo;case 35667:case 35671:return Ho;case 35668:case 35672:return Uo;case 35669:case 35673:return Wo;case 5125:return Go;case 36294:return Ko;case 36295:return qo;case 36296:return Jo;case 35678:case 36198:case 36298:case 36306:case 35682:return Yo;case 35679:case 36299:case 36307:return Xo;case 35680:case 36300:case 36308:case 36293:return Zo;case 36289:case 36303:case 36311:case 36292:return Qo}}var es=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=No(t.type)}},ts=class{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=$o(t.type)}},ns=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){let r=this.seq;for(let i=0,a=r.length;i!==a;++i){let a=r[i];a.setValue(e,t[a.id],n)}}},rs=/(\w+)(\])?(\[|\.)?/g;function is(e,t){e.seq.push(t),e.map[t.id]=t}function as(e,t,n){let r=e.name,i=r.length;for(rs.lastIndex=0;;){let a=rs.exec(r),o=rs.lastIndex,s=a[1],c=a[2]===`]`,l=a[3];if(c&&(s|=0),l===void 0||l===`[`&&o+2===i){is(n,l===void 0?new es(s,e,t):new ts(s,e,t));break}else{let e=n.map[s];e===void 0&&(e=new ns(s),is(n,e)),n=e}}}var os=class{constructor(e,t){this.seq=[],this.map={};let n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<n;++r){let n=e.getActiveUniform(t,r);as(n,e.getUniformLocation(t,n.name),this)}let r=[],i=[];for(let t of this.seq)t.type===e.SAMPLER_2D_SHADOW||t.type===e.SAMPLER_CUBE_SHADOW||t.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(t):i.push(t);r.length>0&&(this.seq=r.concat(i))}setValue(e,t,n,r){let i=this.map[t];i!==void 0&&i.setValue(e,n,r)}setOptional(e,t,n){let r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let i=0,a=t.length;i!==a;++i){let a=t[i],o=n[a.id];o.needsUpdate!==!1&&a.setValue(e,o.value,r)}}static seqWithValue(e,t){let n=[];for(let r=0,i=e.length;r!==i;++r){let i=e[r];i.id in t&&n.push(i)}return n}};function ss(e,t,n){let r=e.createShader(t);return e.shaderSource(r,n),e.compileShader(r),r}var cs=37297,ls=0;function us(e,t){let n=e.split(`
...
void main() {
  ...
  vec3 onSphere  = ${$p} * normalize(worldPos);
...
`;function sm({cards:e}){let t=(0,l.useRef)(null),n=(0,l.useRef)(null),r=(0,l.useRef)(null),i=(0,l.useRef)(null),a=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let o=t.current,s=o.clientWidth||window.innerWidth,c=o.clientHeight||window.innerHeight,l=new Oc({antialias:!0,alpha:!0,premultipliedAlpha:!1});l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.setSize(s,c),l.setClearColor(0,0),o.appendChild(l.domElement);let u=new En,d=new Ji(58,s/c,.1,100);d.position.set(0,0,10.5),d.lookAt(0,0,0);function f(e){let t=document.createElement(`canvas`);t.width=64,t.height=36;let n=t.getContext(`2d`);e!==`transparent`&&(n.fillStyle=e,n.fillRect(0,0,64,36));let r=new ri(t);return r.colorSpace=Ge,r}let p=new Bi,m=[],h=[];for(let t=0;t<Zp;t++){let n=t%e.length,r=e[n],i=new ci(t===0?im:nm,t===0?im:rm,48,32),a=f(r.color),o;if(r.video){let e=document.createElement(`video`);e.src=r.video,e.loop=!0,e.muted=!0,e.playsInline=!0,e.autoplay=!0,e.play().catch(()=>{}),h.push(e),o=new ti(e),o.colorSpace=Ge}else o=p.load(r.image,void 0,void 0,()=>{s.uniforms.uTexture.value=a}),o.colorSpace=Ge;let s=new _i({vertexShader:am,fragmentShader:om,uniforms:{uTexture:{value:o},uCenter:{value:new G},uRight:{value:new G},uUp:{value:new G(0,1,0)},uFlatness:{value:0},uOpacity:{value:1},uBrightness:{value:1},uBlur:{value:0}},transparent:!0,side:2}),c=new Ur(i,s);c.frustumCulled=!1,u.add(c),m.push({mesh:c,mat:s,cardIndex:n})}let g=2.5-(e.length-1),_=2.5,v=2.5,y=-20,b=!1,x=0,S=0,C=1,w=120,T=0,E=0,D=new G;function O(e){m.forEach(({mesh:t,mat:n,cardIndex:r},i)=>{let a=(i+e)/Zp,s=a*Qp*Math.PI*2,c=(a%1+1)%1,l=$p*Math.cos(s),u=$p*Math.sin(s),f=(s%(Math.PI*2)+Math.PI*2)%(Math.PI*2),p=Math.max(0,Math.min(1,(f-Math.PI*.85)/(Math.PI*.3))),m=-((c+.25)%1-.5)*em-p*tm,h=f-Math.PI/2;h>Math.PI&&(h-=Math.PI*2),h<-Math.PI&&(h+=Math.PI*2);let g=Math.abs(h)/Math.PI,_=Math.min(c,1-c)*2,v=Math.min(1,_*30),b=Math.max(.45,1-g*.4);i===0&&(D.set(l,m+y,u),D.project(d),x=(D.x+1)/2*o.clientWidth,S=(1-(D.y+1)/2)*o.clientHeight,C=g,D.set(l+im/2*Math.sin(s)*b,m+y,u-im/2*Math.cos(s)*b),D.project(d),w=Math.abs((D.x+1)/2*o.clientWidth-x)),n.uniforms.uCenter.value.set(l,m+y,u),n.uniforms.uRight.value.set(Math.sin(s)*b,0,-Math.cos(s)*b),n.uniforms.uUp.value.set(0,b,0),n.uniforms.uFlatness.value=Math.max(0,1-g/.1),n.uniforms.uBlur.value=Math.min(1,g*2.5);let E=Math.max(.2,1-g*.7)*v;n.uniforms.uOpacity.value=E*(i===0?1:T),n.uniforms.uBrightness.value=E*(i===0?1:T),t.renderOrder=1-g})}let k=null;function A(){k&&clearTimeout(k),k=setTimeout(()=>{let e=_-1;e>=g&&(_=e,A())},8e3)}let j={y:-20},M=new IntersectionObserver(e=>{e[0].isIntersecting&&!b&&(b=!0,M.disconnect(),Fp.to(j,{y:-.6,duration:2.8,delay:1.2,ease:`power3.out`,onUpdate:()=>{y=j.y}}),setTimeout(()=>{E=1,A()},4500))},{threshold:.1});M.observe(o);let N=new Hp({smoothWheel:!0,wheelMultiplier:0});function ee(e){e.preventDefault(),_-=e.deltaY*.015,_=Math.max(g,Math.min(2.5,_)),A()}o.addEventListener(`wheel`,ee,{passive:!1});let P=e=>{N.raf(e*1e3),v+=(_-v)*.07,T+=(E-T)*.04,O(v),l.render(u,d);let t=Math.max(0,1-C/.35).toFixed(3),s=n.current;s&&(s.style.left=x.toFixed(1)+`px`,s.style.top=S.toFixed(1)+`px`,s.style.opacity=t);let c=Math.max(1,(w+28)/120),f=r.current;f&&(f.style.left=x.toFixed(1)+`px`,f.style.top=S.toFixed(1)+`px`,f.style.transform=`translate(-50%, -50%) scale(${c.toFixed(3)})`,f.style.opacity=t);let p=120*c,m=i.current;if(m){let e=Math.max(0,x-p-24);m.style.width=e.toFixed(0)+`px`,m.style.top=S.toFixed(1)+`px`,m.style.opacity=t}let h=a.current;if(h){let e=x+p+24,n=Math.max(0,o.clientWidth-e);h.style.left=e.toFixed(0)+`px`,h.style.width=n.toFixed(0)+`px`,h.style.top=S.toFixed(1)+`px`,h.style.opacity=t}};Fp.ticker.add(P),Fp.ticker.lagSmoothing(0),O(v);function F(){let e=o.clientWidth,t=o.clientHeight;d.aspect=e/t,d.updateProjectionMatrix(),l.setSize(e,t)}return window.addEventListener(`resize`,F),()=>{h.forEach(e=>{e.pause(),e.src=``}),M.disconnect(),window.removeEventListener(`resize`,F),o.removeEventListener(`wheel`,ee),Fp.ticker.remove(P),N.destroy(),k&&clearTimeout(k),l.dispose(),o.contains(l.domElement)&&o.removeChild(l.domElement)}},[]),(0,Wp.jsxs)(`div`,{style:{width:`100%`,height:`100vh`,background:`#1E1E1E`,position:`relative`,overflow:`hidden`},children:[(0,Wp.jsx)(`div`,{style:{position:`absolute`,inset:0,zIndex:0,pointerEvents:`none`,backgroundImage:`radial-gradient(circle, rgba(255,255,255,0.06) 1px, transparent 1px)`,backgroundSize:`28px 28px`}}),(0,Wp.jsxs)(`div`,{ref:n,style:{position:`absolute`,zIndex:2,pointerEvents:`none`,left:0,top:0,transform:`translate(-50%, -50%)`,width:`340px`,height:`340px`},children:[(0,Wp.jsx)(`div`,{style:{position:`absolute`,width:`160px`,height:`160px`,top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`,borderRadius:`50%`,background:`rgba(5,5,5,0.88)`,filter:`blur(24px)`}}),(0,Wp.jsx)(`div`,{style:{position:`absolute`,width:`260px`,height:`260px`,top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`,borderRadius:`50%`,background:`radial-gradient(circle, rgba(163,230,53,0.60) 0%, rgba(163,230,53,0.28) 40%, transparent 70%)`,filter:`blur(28px)`}})]}),(0,Wp.jsx)(`div`,{ref:t,style:{position:`absolute`,inset:0,zIndex:3}}),(0,Wp.jsx)(`div`,{ref:r,style:{position:`absolute`,zIndex:5,pointerEvents:`none`,left:0,top:0,transform:`translate(-50%, -50%)`,width:`340px`,height:`340px`},children:(0,Wp.jsx)(Xp,{})}),(0,Wp.jsxs)(`div`,{ref:i,style:{position:`absolute`,zIndex:4,pointerEvents:`none`,left:0,top:0,transform:`translateY(-50%)`,width:0,opacity:0,padding:`0 20px 0 24px`,boxSizing:`border-box`,overflow:`hidden`,display:`flex`,flexDirection:`column`,alignItems:`flex-end`},children:[(0,Wp.jsx)(`div`,{style:{color:`#F5F5F7`,fontFamily:`'Montserrat', sans-serif`,fontSize:`40px`,fontWeight:700,lineHeight:1.15,letterSpacing:`-0.5px`,marginBottom:`28px`},children:`EverTutor AI System`}),(0,Wp.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,marginBottom:`28px`},children:[(0,Wp.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`4px`},children:[(0,Wp.jsx)(`div`,{style:{color:`#E5F28D`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`36px`,fontWeight:700,lineHeight:1},children:`2,000+`}),(0,Wp.jsx)(`div`,{style:{color:`rgba(255,252,248,0.60)`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`15px`,fontWeight:500,letterSpacing:`0.02em`},children:`Daily Active Users`})]}),(0,Wp.jsx)(`div`,{style:{width:`1px`,height:`44px`,background:`rgba(255,252,248,0.15)`,margin:`0 24px`,flexShrink:0}}),(0,Wp.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`4px`},children:[(0,Wp.jsx)(`div`,{style:{color:`#E5F28D`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`36px`,fontWeight:700,lineHeight:1},children:`-96%`}),(0,Wp.jsx)(`div`,{style:{color:`rgba(255,252,248,0.60)`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`15px`,fontWeight:500,letterSpacing:`0.02em`},children:`Workflow time`})]})]}),(0,Wp.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`4px`},children:[(0,Wp.jsx)(`div`,{style:{color:`#E5F28D`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`36px`,fontWeight:700,lineHeight:1},children:`0→$300k ARR`}),(0,Wp.jsx)(`div`,{style:{color:`rgba(255,252,248,0.60)`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`15px`,fontWeight:500,letterSpacing:`0.02em`},children:`as Sole Product Designer`})]})]}),(0,Wp.jsxs)(`div`,{ref:a,style:{position:`absolute`,zIndex:4,pointerEvents:`none`,left:0,top:0,transform:`translateY(-50%)`,width:0,opacity:0,padding:`0 24px 0 20px`,boxSizing:`border-box`,overflow:`hidden`},children:[(0,Wp.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`,marginBottom:`28px`},children:[(0,Wp.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:`7px`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`15px`,fontWeight:500,color:`rgba(255,252,248,0.80)`,background:`rgba(255,252,248,0.08)`,border:`1px solid rgba(255,252,248,0.18)`,borderRadius:`6px`,padding:`7px 14px`,letterSpacing:`0.03em`,width:`fit-content`,whiteSpace:`nowrap`},children:[(0,Wp.jsx)(`img`,{src:`Parallax cards/EverTutor Glimpse/Portfolio icons SVG/Profile dark theme.svg`,width:`16`,height:`14`,alt:``,"aria-hidden":`true`}),`Sole Product Designer`]}),(0,Wp.jsxs)(`div`,{style:{display:`flex`,gap:`8px`},children:[(0,Wp.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:`7px`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`15px`,fontWeight:500,color:`rgba(255,252,248,0.80)`,background:`rgba(255,252,248,0.08)`,border:`1px solid rgba(255,252,248,0.18)`,borderRadius:`6px`,padding:`7px 14px`,letterSpacing:`0.03em`,width:`fit-content`,whiteSpace:`nowrap`},children:[(0,Wp.jsx)(`img`,{src:`Parallax cards/EverTutor Glimpse/Portfolio icons SVG/Thunder Dark Theme.svg`,width:`10`,height:`16`,alt:``,"aria-hidden":`true`}),`0 to 1`]}),(0,Wp.jsxs)(`span`,{style:{display:`inline-flex`,alignItems:`center`,gap:`7px`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`15px`,fontWeight:500,color:`rgba(255,252,248,0.80)`,background:`rgba(255,252,248,0.08)`,border:`1px solid rgba(255,252,248,0.18)`,borderRadius:`6px`,padding:`7px 14px`,letterSpacing:`0.03em`,width:`fit-content`,whiteSpace:`nowrap`},children:[(0,Wp.jsx)(`img`,{src:`Parallax cards/EverTutor Glimpse/Portfolio icons SVG/Desktop Icon.svg`,width:`16`,height:`13`,alt:``,"aria-hidden":`true`}),`Desktop · B2B · B2C`]})]})]}),(0,Wp.jsxs)(`p`,{style:{color:`#FFFCF8`,fontSize:`18px`,lineHeight:1.7,margin:0},children:[`World's 1st multi modal 1:1 voice first AI tutor powered by`,` `,(0,Wp.jsx)(`em`,{style:{fontStyle:`italic`,fontWeight:700},children:`3 tools working as one system`}),` `,`to enable billion tutors for billion minds.`]})]})]})}var cm=[{title:`EverTutor`,sub:`AI System`,desc:``,color:`transparent`,image:`/images/blob.png`},{title:`ET Live`,sub:`Adaptive Tutoring`,desc:`85% session completion rate and 2x faster mastery. Real-time AI tutor with adaptive feedback built from scratch.`,color:`#1D9E75`,video:`/images/et-live.mp4`},{title:`ET Studio`,sub:`AI Content System`,desc:`Redesigned the end-to-end content creation workflow — reducing production time from 104 hours to 4 hours per lesson.`,color:`#7F77DD`,video:`/images/et-studio.mp4`},{title:`ET Analytics`,sub:`Learning Intelligence`,desc:`Platform-wide analytics for 2,000+ DAU — surfacing mastery signals and content performance in real time.`,color:`#D85A30`,video:`/images/et-analytics.mp4`},{title:`Dearly`,sub:`Digital Letters`,desc:`A handwritten-style letter app for heartfelt notes. Launched on Product Hunt with custom SVG glyph rendering.`,color:`#D4537E`,video:`/images/dearly.mp4`},{title:`Stressie`,sub:`Wellness Companion`,desc:`A calm, supportive app for managing stress and anxiety. Designed with care for emotional UX and daily check-ins.`,color:`#6BBFA3`,video:`/images/stressie.mp4`}];function lm(){let e=document.getElementById(`spiral-root`);e&&(0,u.createRoot)(e).render((0,Wp.jsx)(sm,{cards:cm}))}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,lm):lm()})();