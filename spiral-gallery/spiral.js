...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Va(e,t,n){let r=new Float32Array(Da),i=new G(0,1,0);return new gi({name:`SphericalGaussianBlur`,defines:{n:Da,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Wa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ha(){return new gi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Wa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ua(){return new gi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Wa(),fragmentShader:`
	...
	`}var Ga=class extends zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ti(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function om({cards:e}){let t=(0,l.useRef)(null),n=(0,l.useRef)(null),r=(0,l.useRef)(null),i=(0,l.useRef)(null),a=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let o=t.current,s=o.clientWidth||window.innerWidth,c=o.clientHeight||window.innerHeight,l=new kc({antialias:!0,alpha:!0,premultipliedAlpha:!1});l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.setSize(s,c),l.setClearColor(0,0),o.appendChild(l.domElement);let u=new En,d=new Ji(58,s/c,.1,100);d.position.set(0,0,10.5),d.lookAt(0,0,0);function f(e){let t=document.createElement(`canvas`);t.width=64,t.height=36;let n=t.getContext(`2d`);e!==`transparent`&&(n.fillStyle=e,n.fillRect(0,0,64,36));let r=new ni(t);return r.colorSpace=Ge,r}let p=new Bi,m=[];for(let t=0;t<Xp;t++){let n=t%e.length,r=e[n],i=new si(t===0?rm:tm,t===0?rm:nm,48,32),a=f(r.color),o=p.load(r.image,void 0,void 0,()=>{s.uniforms.uTexture.value=a});o.colorSpace=Ge;let s=new gi({vertexShader:im,fragmentShader:am,uniforms:{uTexture:{value:o},uCenter:{value:new G},uRight:{value:new G},uUp:{value:new G(0,1,0)},uFlatness:{value:0},uOpacity:{value:1},uBrightness:{value:1},uBlur:{value:0}},transparent:!0,side:2}),c=new Ur(i,s);c.frustumCulled=!1,u.add(c),m.push({mesh:c,mat:s,cardIndex:n})}let h=2.5,g=2.5,_=-20,v=!1,y=0,b=0,x=1,S=120,C=0,w=0,T=new G;function E(e){m.forEach(({mesh:t,mat:n,cardIndex:r},i)=>{let a=(i+e)/Xp,s=a*Zp*Math.PI*2,c=(a%1+1)%1,l=Qp*Math.cos(s),u=Qp*Math.sin(s),f=(s%(Math.PI*2)+Math.PI*2)%(Math.PI*2),p=Math.max(0,Math.min(1,(f-Math.PI*.85)/(Math.PI*.3))),m=-((c+.25)%1-.5)*$p-p*em,h=f-Math.PI/2;h>Math.PI&&(h-=Math.PI*2),h<-Math.PI&&(h+=Math.PI*2);let g=Math.abs(h)/Math.PI,v=Math.min(c,1-c)*2,w=Math.min(1,v*30),E=Math.max(.45,1-g*.4);i===0&&(T.set(l,m+_,u),T.project(d),y=(T.x+1)/2*o.clientWidth,b=(1-(T.y+1)/2)*o.clientHeight,x=g,T.set(l+rm/2*Math.sin(s)*E,m+_,u-rm/2*Math.cos(s)*E),T.project(d),S=Math.abs((T.x+1)/2*o.clientWidth-y)),n.uniforms.uCenter.value.set(l,m+_,u),n.uniforms.uRight.value.set(Math.sin(s)*E,0,-Math.cos(s)*E),n.uniforms.uUp.value.set(0,E,0),n.uniforms.uFlatness.value=Math.max(0,1-g/.1),n.uniforms.uBlur.value=Math.min(1,g*2.5);let D=Math.max(.2,1-g*.7)*w;n.uniforms.uOpacity.value=D*(i===0?1:C),n.uniforms.uBrightness.value=D*(i===0?1:C),t.renderOrder=1-g})}let D=null;function O(){D&&clearTimeout(D),D=setTimeout(()=>{let e=h-1;e>=-6.5&&(h=e,O())},8e3)}let k={y:-20},A=new IntersectionObserver(e=>{e[0].isIntersecting&&!v&&(v=!0,A.disconnect(),Fp.to(k,{y:-.6,duration:2.8,delay:1.2,ease:`power3.out`,onUpdate:()=>{_=k.y}}),setTimeout(()=>{w=1,O()},4500))},{threshold:.1});A.observe(o);let j=new Hp({smoothWheel:!0,wheelMultiplier:0});function M(e){e.preventDefault(),h-=e.deltaY*.015,h=Math.max(-6.5,Math.min(2.5,h)),O()}o.addEventListener(`wheel`,M,{passive:!1});let N=e=>{j.raf(e*1e3),g+=(h-g)*.07,C+=(w-C)*.04,E(g),l.render(u,d);let t=Math.max(0,1-x/.35).toFixed(3),s=n.current;s&&(s.style.left=y.toFixed(1)+`px`,s.style.top=b.toFixed(1)+`px`,s.style.opacity=t);let c=Math.max(1,(S+28)/120),f=r.current;f&&(f.style.left=y.toFixed(1)+`px`,f.style.top=b.toFixed(1)+`px`,f.style.transform=`translate(-50%, -50%) scale(${c.toFixed(3)})`,f.style.opacity=t);let p=120*c,m=i.current;if(m){let e=Math.max(0,y-p-24);m.style.width=e.toFixed(0)+`px`,m.style.top=b.toFixed(1)+`px`,m.style.opacity=t}let _=a.current;if(_){let e=y+p+24,n=Math.max(0,o.clientWidth-e);_.style.left=e.toFixed(0)+`px`,_.style.width=n.toFixed(0)+`px`,_.style.top=b.toFixed(1)+`px`,_.style.opacity=t}};Fp.ticker.add(N),Fp.ticker.lagSmoothing(0),E(g);function ee(){let e=o.clientWidth,t=o.clientHeight;d.aspect=e/t,d.updateProjectionMatrix(),l.setSize(e,t)}return window.addEventListener(`resize`,ee),()=>{A.disconnect(),window.removeEventListener(`resize`,ee),o.removeEventListener(`wheel`,M),Fp.ticker.remove(N),j.destroy(),D&&clearTimeout(D),l.dispose(),o.contains(l.domElement)&&o.removeChild(l.domElement)}},[]),(0,$.jsxs)(`div`,{style:{width:`100%`,height:`100vh`,background:`#1E1E1E`,position:`relative`,overflow:`hidden`},children:[(0,$.jsx)(`div`,{style:{position:`absolute`,inset:0,zIndex:0,pointerEvents:`none`,backgroundImage:`radial-gradient(circle, rgba(255,255,255,0.06) 1px, transparent 1px)`,backgroundSize:`28px 28px`}}),(0,$.jsxs)(`div`,{ref:n,style:{position:`absolute`,zIndex:2,pointerEvents:`none`,left:0,top:0,transform:`translate(-50%, -50%)`,width:`340px`,height:`340px`},children:[(0,$.jsx)(`div`,{style:{position:`absolute`,width:`160px`,height:`160px`,top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`,borderRadius:`50%`,background:`rgba(5,5,5,0.88)`,filter:`blur(24px)`}}),(0,$.jsx)(`div`,{style:{position:`absolute`,width:`260px`,height:`260px`,top:`50%`,left:`50%`,transform:`translate(-50%, -50%)`,borderRadius:`50%`,background:`radial-gradient(circle, rgba(163,230,53,0.60) 0%, rgba(163,230,53,0.28) 40%, transparent 70%)`,filter:`blur(28px)`}})]}),(0,$.jsx)(`div`,{ref:t,style:{position:`absolute`,inset:0,zIndex:3}}),(0,$.jsx)(`div`,{ref:r,style:{position:`absolute`,zIndex:5,pointerEvents:`none`,left:0,top:0,transform:`translate(-50%, -50%)`,width:`340px`,height:`340px`},children:(0,$.jsx)(Yp,{})}),(0,$.jsxs)(`div`,{ref:i,style:{position:`absolute`,zIndex:4,pointerEvents:`none`,left:0,top:0,transform:`translateY(-50%)`,width:0,opacity:0,padding:`0 20px 0 24px`,boxSizing:`border-box`,overflow:`hidden`},children:[(0,$.jsx)(`div`,{style:{color:`#E5F28D`,fontFamily:`'Montserrat', sans-serif`,fontSize:`40px`,fontWeight:700,lineHeight:1.1,marginBottom:`20px`},children:`EverTutor AI System`}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`flex-start`,marginBottom:`16px`},children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{style:{color:`#E5F28D`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`36px`,fontWeight:700,lineHeight:1},children:`2,000+`}),(0,$.jsx)(`div`,{style:{color:`rgba(255,252,248,0.5)`,fontSize:`12px`,marginTop:`6px`},children:`Daily Active Users`})]}),(0,$.jsx)(`div`,{style:{width:`1px`,background:`rgba(255,252,248,0.15)`,alignSelf:`stretch`,margin:`0 20px`,flexShrink:0}}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{style:{color:`#E5F28D`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`36px`,fontWeight:700,lineHeight:1},children:`-96%`}),(0,$.jsx)(`div`,{style:{color:`rgba(255,252,248,0.5)`,fontSize:`12px`,marginTop:`6px`},children:`Workflow time`})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`div`,{style:{color:`#E5F28D`,fontFamily:`'JetBrains Mono', monospace`,fontSize:`36px`,fontWeight:700,lineHeight:1},children:`0→$300k ARR`}),(0,$.jsx)(`div`,{style:{color:`rgba(255,252,248,0.45)`,fontSize:`12px`,marginTop:`6px`},children:`as Sole Product Designer`})]})]}),(0,$.jsxs)(`div`,{ref:a,style:{position:`absolute`,zIndex:4,pointerEvents:`none`,left:0,top:0,transform:`translateY(-50%)`,width:0,opacity:0,padding:`0 24px 0 20px`,boxSizing:`border-box`,overflow:`hidden`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`,marginBottom:`20px`},children:[(0,$.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,gap:`7px`,border:`1px solid rgba(255,252,248,0.2)`,borderRadius:`100px`,padding:`6px 14px`,color:`rgba(255,252,248,0.82)`,width:`fit-content`,background:`rgba(255,252,248,0.05)`},children:[(0,$.jsxs)(`svg`,{width:`13`,height:`13`,viewBox:`0 0 13 13`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,$.jsx)(`circle`,{cx:`6.5`,cy:`3.5`,r:`2.5`,fill:`currentColor`}),(0,$.jsx)(`path`,{d:`M1 12c0-3.04 2.46-5.5 5.5-5.5S12 8.96 12 12`,stroke:`currentColor`,strokeWidth:`1.2`,strokeLinecap:`round`})]}),(0,$.jsx)(`span`,{style:{fontFamily:`'Montserrat', sans-serif`,fontSize:`16px`,fontWeight:500,whiteSpace:`nowrap`},children:`Sole Product Designer`})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,flexWrap:`wrap`},children:[(0,$.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,gap:`7px`,border:`1px solid rgba(255,252,248,0.2)`,borderRadius:`100px`,padding:`6px 14px`,color:`rgba(255,252,248,0.82)`,width:`fit-content`,background:`rgba(255,252,248,0.05)`},children:[(0,$.jsx)(`svg`,{width:`11`,height:`14`,viewBox:`0 0 11 14`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,$.jsx)(`path`,{d:`M6.5 0L1 7.5h4.5L3.5 14l7-8.5H6L6.5 0z`})}),(0,$.jsx)(`span`,{style:{fontFamily:`'Montserrat', sans-serif`,fontSize:`16px`,fontWeight:500,whiteSpace:`nowrap`},children:`0 to 1`})]}),(0,$.jsxs)(`div`,{style:{display:`inline-flex`,alignItems:`center`,gap:`7px`,border:`1px solid rgba(255,252,248,0.2)`,borderRadius:`100px`,padding:`6px 14px`,color:`rgba(255,252,248,0.82)`,width:`fit-content`,background:`rgba(255,252,248,0.05)`},children:[(0,$.jsx)(`svg`,{width:`13`,height:`12`,viewBox:`0 0 13 12`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,$.jsx)(`path`,{d:`M11 0H2C.9 0 0 .9 0 2v6c0 1.1.9 2 2 2h2.5l2 2.5L8.5 10H11c1.1 0 2-.9 2-2V2c0-1.1-.9-2-2-2z`})}),(0,$.jsx)(`span`,{style:{fontFamily:`'Montserrat', sans-serif`,fontSize:`16px`,fontWeight:500,whiteSpace:`nowrap`},children:`Desktop · B2B · B2C`})]})]})]}),(0,$.jsxs)(`p`,{style:{color:`rgba(255,252,248,0.82)`,fontFamily:`'Montserrat', sans-serif`,fontSize:`18px`,lineHeight:1.6,margin:0},children:[`World's 1st multi modal 1:1 voice first AI tutor powered by`,` `,(0,$.jsx)(`strong`,{style:{fontStyle:`italic`},children:`3 tools working as one system`}),` `,`to enable billion tutors for billion minds.`]})]})]})}var sm=[{title:``,sub:``,desc:``,color:`transparent`,image:`/images/blob.png`},{title:`ET Studio`,sub:`AI Content System`,desc:`Redesigned the end-to-end content creation workflow — reducing production time from 104 hours to 4 hours per lesson.`,color:`#7F77DD`,image:`/images/et-studio.png`},{title:`ET Live`,sub:`Adaptive Tutoring`,desc:`85% session completion rate and 2x faster mastery. Real-time AI tutor with adaptive feedback built from scratch.`,color:`#1D9E75`,image:`/images/et-live.png`},{title:`ET Analytics`,sub:`Learning Intelligence`,desc:`Platform-wide analytics for 2,000+ DAU — surfacing mastery signals and content performance in real time.`,color:`#D85A30`,image:`/images/et-analytics.png`},{title:`Dearly`,sub:`Digital Letters`,desc:`A handwritten-style letter app for heartfelt notes. Launched on Product Hunt with custom SVG glyph rendering.`,color:`#D4537E`,image:`/images/dearly.png`}];function cm(){let e=document.getElementById(`spiral-root`);e&&(0,u.createRoot)(e).render((0,$.jsx)(om,{cards:sm}))}document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,cm):cm()})();